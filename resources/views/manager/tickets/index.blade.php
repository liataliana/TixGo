            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50 transition-colors duration-200 group transform hover:-translate-y-1 hover:shadow-md" style="transform-style: preserve-3d; perspective: 1000px;">
                    ...
                    <td class="px-6 py-4 text-right space-x-2">
                        ...
                        <form action="{{ route('manager.tickets.destroy', $ticket->id) }}" method="POST" class="inline-block" onsubmit="return confirm('Apakah Anda yakin ingin menghapus tiket ini?');">
                            @csrf
                            @method('DELETE')

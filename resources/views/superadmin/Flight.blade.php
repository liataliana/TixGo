...
<style>
    ...
    .flight-status.available::before {
        content: '';
        width: 6px;
        height: 6px;
        border-radius: 50%;
...
<div class="superadmin-wrapper max-w-7xl mx-auto">
    ...
    <div class="header-super">
        <div class="title-group">
            ...
            <div>
                <h1>Semua Penerbangan</h1>
                <div class="sub">
                    <i class="fa-regular fa-bolt" style="color: #0099ff; font-size: 0.7rem;"></i>
                    Pantau semua jadwal penerbangan di sistem
                </div>
            </div>
        </div>
        <div class="badge-super">
            <i class="fa-regular fa-plane-departure" style="color: #0099ff;"></i>
            {{ $flights->count() }} Penerbangan
        </div>
    </div>
    ...
    <div class="glass-card-super">
            ...
            <table class="table-super">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="font-size: 0.8rem; color: #5a7a9a;">
                        ...
                        <td style="text-align: center;">
                            <span class="flight-status {{ $status }}">
                                {{ $statusLabel }}
                            </span>
                        </td>
                    </tr>
                    @empty
                    <tr>
                        <td colspan="6" class="text-center py-8 text-[#5a7a9a]">Belum ada penerbangan</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
        ...
        <div class="table-footer">
            <span class="total-info">
                <i class="fa-regular fa-plane" style="color: #0099ff;"></i>
                Total <strong>{{ $flights->count() }}</strong> penerbangan
                @php
                    $available = $flights->filter(function($f) {
                        return !\Carbon\Carbon::parse($f->departure_time)->isPast();
                    })->count();
                @endphp
                <span style="color: #10b981; font-weight: 800;">| {{ $available }} tersedia</span>
            </span>
